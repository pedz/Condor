class CreateNotBuiltYetObjects < ActiveRecord::Migration
  def self.up
    ...
    version = Version.find_or_create_by_name("Not Built Yet")
    release = Release.find_or_create_by_name_and_family_id_and_version_id("Not Built Yet", family.id, version.id)
