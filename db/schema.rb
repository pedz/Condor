...
ActiveRecord::Schema.define(:version => 41) do
  ...
  add_index "fileset_aix_file_maps", ["aix_file_id", "fileset_id"], :name => "fileset_aix_file_maps_fileset_id_key", :unique => true
  ...
  add_index "lpps", ["lpp_base_id", "name"], :name => "lpps_name_key", :unique => true
  ...
  add_index "package_fileset_maps", ["fileset_id", "package_id"], :name => "package_fileset_maps_package_id_key", :unique => true
  ...
  add_index "releases", ["family_id", "name"], :name => "releases_name_key", :unique => true
  ...
  add_index "service_pack_fileset_maps", ["fileset_id", "service_pack_id"], :name => "service_pack_fileset_maps_service_pack_id_key", :unique => true
